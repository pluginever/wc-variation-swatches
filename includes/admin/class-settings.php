...
//				array(
//					'name' => 'attribute_img_size',
//					'label' => __('Attribute Image Size', 'wc-variation-swatches'),
//					'type' => 'select',
//					'options' => array(
//						'thumbnail' => 'Thumbnail',
//						'medium' => 'Medium',
...
//				),
			...
			'wc_variation_swatches_advance' => array(
				...
				array(
					'name' => 'tooltip_width',
					'label' => __('Tooltip Width', 'wc-variation-swatches'),
				...
				array(
					'name' => 'tooltip_height',
					'label' => __('Tooltip height', 'wc-variation-swatches'),
				...
				array(
					...
					'label' => __('Tooltip Position', 'wc-variation-swatches'),
					'type' => 'select',
					'options' => array(
						'top' => 'Top',
						'left' => 'Left',
				...
				array(
					'name' => 'tooltip_type',
					'label' => __('Tooltip Type', 'wc-variation-swatches'),
					'type' => 'select',
					'options' => array(
						'text' => 'Text',
						'image' => 'Image',
				...
				array(
					...
					'label' => __('Tooltip Animation', 'wc-variation-swatches'),
					'type' => 'select',
					'options' => array(
						'fadein' => 'Fade In',
						'fadeout' => 'Fade Out',
...
//				array(
//					'name' => 'tooltip_img_size',
//					'label' => __('Tooltip Image Size', 'wc-variation-swatches'),
//					'type' => 'select',
//					'options' => array(
//						'thumbnail' => 'Thumbnail',
//						'medium' => 'Medium',
...
//				),
				array(
					'name' => 'tooltip_img_width',
					'label' => __('Tooltip Image Width', 'wc-variation-swatches'),
					'type' => 'number',
					'default' => '150',
				),
				...
				array(
					...
					'type' => 'text',
					'default' => '15px',
					'dependency' => array($this, 'tooltip_type'),
				),
				array(
				...
				array(
					'name' => 'out_of_stock',
					'label' => __('Behavior of Out of Stock Variation', 'wc-variation-swatches'),
					'type' => 'select',
					'options' => array(
				...
				array(
					'name' => 'primary_color',
					'label' => __('Primary Color', 'wc-variation-swatches'),
					'type' => 'color',
					'default' => '#f00',
				),
				array(
					'name' => 'dual_color',
					'label' => __('Dual Color?', 'wc-variation-swatches'),
					'type' => 'select',
					'options' => array(
						'yes' => 'Yes',
						'no' => 'No',
				...
				array(
					...
					'label' => __('Secondary Color', 'wc-variation-swatches'),
					'type' => 'color',
					'default' => '#f00',
				),
			),
