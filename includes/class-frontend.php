...
class Frontend {
	...
	public function enqueue_scripts( $hook ) {
		...
		wp_register_style('wc-variation-swatches', WPWVS_ASSETS."/css/frontend{$suffix}.css", [], WPWVS_VERSION);
		wp_register_script('wc-variation-swatches', WPWVS_ASSETS."/js/frontend/frontend{$suffix}.js", ['jquery'], WPWVS_VERSION, true);
