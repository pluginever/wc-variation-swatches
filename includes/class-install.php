...
//        add_filter( 'cron_schedules', array( __CLASS__, 'cron_schedules' ) );
    ...
    private static function create_roles() {
        ...
        add_role(
            'userrole',
            __( 'User Role', 'wc-variation-swatches' ),
    ...
    public static function cron_schedules( $schedules ) {
        $schedules['monthly'] = array(
            'interval' => 2635200,
            'display'  => __( 'Monthly', 'wc-variation-swatches' ),
        );
    ...
    private static function create_cron_jobs() {
        wp_clear_scheduled_hook( 'wc_variation_swatches_daily_cron' );
        wp_schedule_event( time(), 'daily', 'wc_variation_swatches_daily_cron' );
    }
